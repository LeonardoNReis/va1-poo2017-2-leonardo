...
public class Operacoes {
	...
	/**
	 * Fazer com que este método não retorne nada e lance a 'EvolucaoException'
	 * quando o pokemon não estiver com CP para evoluir. Sempre que o pokemon
	 * não estiver com no mínimo de CP lance a 'EvolucaoException'. Se estiver
	 * com pelo menos o mínimo de CP, setar 1 no CP deste pokemon.
	 */
	public void evoluir(Pokemon p) throws EvolucaoException {
		Long cpAtual = p.getCp();
		if (cpAtual < 80) {
